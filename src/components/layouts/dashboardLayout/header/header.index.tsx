...
import { APIPath } from '/src/data';
import { toast } from 'react-hot-toast';
import { BsPersonCircle } from 'react-icons/bs';
import { GiHamburgerMenu } from 'react-icons/gi';
import DevbroLogo from './devbroLogo';
...
const HeaderComp: React.FC = () => {
  const context: GlobalContext = useContext(GlobalContext);
  ...
  function toggleSideBar() {
    context.update('showSideBar', !context.showSideBar);
  }
  ...
  function toggleMode() {
    ...
    context.update('darkMode', new_mode);
  }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-start">
          ...
          <a href="#" className="flex ml-2 md:mr-24 max-h-10">
            ...
            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-deep-blue dark:text-gray-200">
              Devbro's Lead Management System
            </span>
          </a>
        </div>
        <div className="flex items-center">
          ...
          <div className="flex items-center ml-3">
            <Popover>
              <Popover.Button className="align-middle relative">

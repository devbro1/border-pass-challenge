...
import { GlobalContext } from '/src/utilities/context';
import { BoxComp } from '../../box/box.index';
  ...
  return (
    <>
      ...
      <div className="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        <SideNavComp />
        <div
          className={'fixed inset-0 z-10 bg-gray-900/50 dark:bg-gray-900/90 ' + (context.showSideBar ? '' : 'hidden')}
          onClick={() => {
            context.update('showSideBar', false);
          }}
          id="sidebarBackdrop"
        ></div>
        <div id="main-content" className="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-0 dark:bg-gray-900">
          <main className="text-gray-600 dark:text-gray-400">
            <BoxComp>{props.children}</BoxComp>
          </main>
